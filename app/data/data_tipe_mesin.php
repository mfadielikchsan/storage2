<?php 
// Inisialisasi variabel $id_form
$id_form = isset($id_form) ? $id_form : ""; // Memberikan nilai default jika belum di-set sebelumnya
?>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- Input id_form -->
                <input type="text" class="form-control" id="id_form" name="id_form" value="<?php echo $id_form; ?>" readonly>
