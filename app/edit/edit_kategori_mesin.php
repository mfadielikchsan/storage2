                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="edit_form_process.php" method="post">
                            <input type="hidden" name="form_id" value="<?php echo $view['id_form']; ?>">
                            <div class="col">
                                <div class="form-group">
                                    <label for="codeform">Code FORM</label>
                                    <div class="select2-blue">
                                        <div class="select2-blue">
                                            <input type="text" name="form_nm" id="form_nm" class="form-control form-control-sm" value="<?php echo $view['nm_form']; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
