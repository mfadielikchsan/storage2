...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if (!$mesin) {
        // Redirect to the index.php if the data is not found
        header('Location: index.php');
        exit();
    }
} else {
    // Redirect to the index.php if no ID is provided
    header('Location: index.php');
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_query($conn_mesin, $updateQuery)) {
        ...
        $id_kat_mesin = mysqli_real_escape_string($conn_pm, $_POST['id_kat_mesin']);
...
<div class="card card-warning">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form method="post" action="edit.php?id=<?php echo $mesin['id']; ?>" enctype="multipart/form-data">
