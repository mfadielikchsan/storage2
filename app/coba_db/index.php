...
<head>
  ...
  <!-- Add these lines for jQuery and Bootstrap -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="edit.php?id=<?php echo $mesin['id'];?>" class="btn btn-sm btn-success"><i class="fa fa-edit"></i> Edit</a>
                    </td>
                  </tr>
                  <?php } ?>
                  </tbody>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                  ...
                  <div class="col mb-3">
                    <label for="item">Mesin Ke</label>
                    <input type="text" class="form-control" placeholder="Mesin Ke" name="machno" required>
                  </div>
                  <div class="col mb-3">
